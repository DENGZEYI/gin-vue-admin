...
type BusOrder struct {
	...
	ApproveTime     time.Time        `gorm:"default:null"json:"approve_time" form:"approve_time"` // 审批时间
	...
	PurchaseTime    time.Time        `gorm:"default:null"json:"purchase_time" form:"purchase_time"` // 审批时间
